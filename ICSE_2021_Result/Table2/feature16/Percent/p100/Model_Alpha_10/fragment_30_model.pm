dtmc
 ...
 const double P30_74_17;// = ((p59)); 
  const double P30_74_18 ;// = (((-1)*p59+1));
 const double P30_75_19;// = ((p60)); 
  const double P30_75_20 ;// = (((-1)*p60+1));
 const double P30_76_21;// = ((p61)); 
  const double P30_76_29 ;// = (((-1)*p61+1));
 const double P30_77_22;// = ((p62)); 
  const double P30_77_30 ;// = (((-1)*p62+1));
 const double P30_78_23;// = ((p63)); 
  const double P30_78_31 ;// = (((-1)*p63+1));
 const double P30_79_24;// = ((p64)); 
  const double P30_79_32 ;// = (((-1)*p64+1));
...
s : [59 .. 150] init 59; 
 ...
 [] s=73 -> ((1)):(s'=70); 
 [] s=74 -> (P30_74_17):(s'=75) + (P30_74_18):(s'=81); 
 [] s=75 -> (P30_75_19):(s'=76) + (P30_75_20):(s'=78); 
 [] s=76 -> (P30_76_21):(s'=77) + (P30_76_29):(s'=144); 
 [] s=77 -> (P30_77_22):(s'=80) + (P30_77_30):(s'=145); 
 [] s=78 -> (P30_78_23):(s'=79) + (P30_78_31):(s'=146); 
 [] s=79 -> (P30_79_24):(s'=80) + (P30_79_32):(s'=147); 
 [] s=80 -> ((1)):(s'=74); 
 [] s=81 -> ((1)):(s'=67); 
 [] s=82 -> true; 
 [] s=142 -> true; 
