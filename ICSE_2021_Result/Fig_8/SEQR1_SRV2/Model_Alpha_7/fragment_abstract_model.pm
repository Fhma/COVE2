dtmc
 ...
 const double PX_0_1 ;// = ( ( (p31) ) * ( prob_f1_s3 ) + ( (p51) ) * ( prob_f1_s5 ) ); 
  ...
  const double PX_0_6 ;// = (  ( 1 ) * ( prob_f1_s30 ) + ( 1 ) * ( prob_f1_s31 )  + ( 1 ) * ( prob_f1_s32 ) );
 const double PX_1_7 ;// = (( 1 ) * ( prob_f2_s33 )); 
  const double PX_1_8 ;// = (( 1 ) * ( prob_f2_s34 ));
 const double PX_2_9 ;// = (( 1 ) * ( prob_f3_s35 )); 
  const double PX_2_10 ;// = (( 1 ) * ( prob_f3_s36 ));
 const double PX_3_11 ;// = (( 1 ) * ( prob_f4_s37 )); 
  const double PX_3_12 ;// = (( 1 ) * ( prob_f4_s38 ));
 const double PX_4_13 ;// = (( 1 ) * ( prob_f5_s39 )); 
  const double PX_4_14 ;// = (( 1 ) * ( prob_f5_s40 ));
 const double PX_5_15 ;// = (( 1 ) * ( prob_f6_s41 )); 
  const double PX_5_16 ;// = (( 1 ) * ( prob_f6_s42 ));
 const double PX_6_17 ;// = (( 1 ) * ( prob_f7_s43 )); 
  const double PX_6_18 ;// = (( 1 ) * ( prob_f7_s44 ));
