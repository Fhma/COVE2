dtmc
 ...
 const double P1_16_21;// = ((r11)); 
  const double P1_16_22 ;// = (((-1)*r11+1));
 const double P1_17_23;// = ((r21)); 
  const double P1_17_24 ;// = (((-1)*r21+1));
 const double P1_19_25;// = ((r41)); 
  const double P1_19_26 ;// = (((-1)*r41+1));
 const double P1_25_27;// = ((r42)); 
  const double P1_25_32 ;// = (((-1)*r42+1));
 const double P1_27_28;// = ((r22)); 
  const double P1_27_30 ;// = (((-1)*r22+1));
 const double P1_28_29;// = ((r12)); 
  const double P1_28_31 ;// = (((-1)*r12+1));
...
s : [0 .. 31] init 0; 
 ...
 [] s=16 -> (P1_16_21):(s'=1) + (P1_16_22):(s'=15); 
 [] s=17 -> (P1_17_23):(s'=2) + (P1_17_24):(s'=14); 
 [] s=19 -> (P1_19_25):(s'=4) + (P1_19_26):(s'=12); 
 [] s=25 -> (P1_25_27):(s'=12) + (P1_25_32):(s'=31); 
 [] s=27 -> (P1_27_28):(s'=14) + (P1_27_30):(s'=29); 
 [] s=28 -> (P1_28_29):(s'=15) + (P1_28_31):(s'=30); 
 [] s=29 -> true; 
 [] s=30 -> true; 
 [] s=31 -> true; 
