...
//prob, cost, time
//MODEL_PATTERNS
//1:PROBR2-4;2:PROBR2-4;3:PROBR2-4;4:PROBR2-4;5:PROBR2-4;6:PROBR2-4
//MONOLITHIC
...
const double z11=0.25;
const double z12=0.25;
const double z13=0.25;
const double z14 =0.25;
...
const double z21 =0.25;
const double z22 =0.25;
const double z23 =0.25;
const double z24 =0.25;
...
const double z31 =0.25;
const double z32 =0.25;
const double z33 =0.25;
const double z34 =0.25;
...
const double z41 =0.25;
const double z42 =0.25;
const double z43 =0.25;
const double z44 =0.25;
...
const double z51 =0.25;
const double z52 =0.25;
const double z53 =0.25;
const double z54 =0.25;
...
const double z61 =0.25;
const double z62 =0.25;
const double z63 =0.25;
const double z64 =0.25;
...
[choice1] (state=1)&(op1=0)&(retry=1) -> z11:(op1'=1)+z12:(op1'=2)+z13:(op1'=3)+z14:(op1'=4);
...
[choice2] (state=2)&(op2=0)&(retry=1) -> z21:(op2'=1)+z22:(op2'=2)+z23:(op2'=3)+z24:(op2'=4);
...
[choice3] (state=3)&(op3=0)&(retry=1) -> z31:(op3'=1)+z32:(op3'=2)+z33:(op3'=3)+z34:(op3'=4);
...
[choice4] (state=4)&(op4=0)&(retry=1) -> z41:(op4'=1)+z42:(op4'=2)+z43:(op4'=3)+z44:(op4'=4);
...
[choice5] (state=5)&(op5=0)&(retry=1) -> z51:(op5'=1)+z52:(op5'=2)+z53:(op5'=3)+z54:(op5'=4);
...
[choice6] (state=6)&(op6=0)&(retry=1) -> z61:(op6'=1)+z62:(op6'=2)+z63:(op6'=3)+z64:(op6'=4);
