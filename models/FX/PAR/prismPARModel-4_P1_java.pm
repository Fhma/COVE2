...
//prob, cost, time
//MODEL_PATTERNS
//1:PAR-4;2:PAR-4;3:PAR-4;4:PAR-4;5:PAR-4;6:PAR-4
//MONOLITHIC
...
[succ1]((s11=2)|(s12=2)|(s13=2)|(s14=2))&(inter=2) -> (state'=2)&(inter'=1);
[fail1]((s11=3)&(s12=3)&(s13=3)&(s14=3))&(inter=2) -> (state'=9)&(inter'=1);
[op2] (state=2) -> (inter'=2);
//if at least one service was successful go to the next operation.
[succ2]((s21=2)|(s22=2)|(s23=2)|(s24=2))&(inter=2) -> (state'=7)&(inter'=1);
[fail2]((s21=3)&(s22=3)&(s23=3)&(s24=3))&(inter=2) -> (state'=9)&(inter'=1);
[op3] (state=3) -> (inter'=2);
//if at least one service was successful go to the next operation.
[succ3]((s31=2)|(s32=2)|(s33=2)|(s34=2))&(inter=2) -> (state'=6)&(inter'=1);
[fail3]((s31=3)&(s32=3)&(s33=3)&(s34=3))&(inter=2) -> (state'=9)&(inter'=1);
[op4] (state=4) -> (inter'=2);
//if at least one service was successful go to the next operation.
[succ4]((s41=2)|(s42=2)|(s43=2)|(s44=2))&(inter=2) -> (state'=8)&(inter'=1);
[fail4]((s41=3)&(s42=3)&(s43=3)&(s44=3))&(inter=2) -> (state'=9)&(inter'=1);
[op5] (state=5) -> (inter'=2);
//if at least one service was successful go to the next operation.
[succ5]((s51=2)|(s52=2)|(s53=2)|(s54=2))&(inter=2) -> (state'=6)&(inter'=1);
[fail5]((s51=3)&(s52=3)&(s53=3)&(s54=3))&(inter=2) -> (state'=9)&(inter'=1);
[op6] (state=6) -> (inter'=2);
//if at least one service was successful go to the next operation.
[succ6]((s61=2)|(s62=2)|(s63=2)|(s64=2))&(inter=2) -> (state'=10)&(inter'=1);
[fail6]((s61=3)&(s62=3)&(s63=3)&(s64=3))&(inter=2) -> (state'=9)&(inter'=1);
endmodule
...
rewards "time"
 ...
 (state=1)&(inter=1): p11*t11+p12*t12*(1-p11)+p13*t13*(1-p11)*(1-p12)+p14*t14*(1-p11)*(1-p12)*(1-p13);
 (state=2)&(inter=1): p21*t21+p22*t22*(1-p21)+p23*t23*(1-p21)*(1-p22)+p24*t24*(1-p21)*(1-p22)*(1-p23);
 (state=3)&(inter=1): p31*t31+p32*t32*(1-p31)+p33*t33*(1-p31)*(1-p32)+p34*t34*(1-p31)*(1-p32)*(1-p33);
 (state=4)&(inter=1): p41*t41+p42*t42*(1-p41)+p43*t43*(1-p41)*(1-p42)+p44*t44*(1-p41)*(1-p42)*(1-p43);
 (state=5)&(inter=1): p51*t51+p52*t52*(1-p51)+p53*t53*(1-p51)*(1-p52)+p54*t54*(1-p51)*(1-p52)*(1-p53);
 (state=6)&(inter=1): p61*t61+p62*t62*(1-p61)+p63*t63*(1-p61)*(1-p62)+p64*t64*(1-p61)*(1-p62)*(1-p63);
endrewards
