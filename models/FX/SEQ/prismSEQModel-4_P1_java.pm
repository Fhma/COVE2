...
//prob, cost, time
//MODEL_PATTERNS
//1:SEQ-4;2:SEQ-4;3:SEQ-4;4:SEQ-4;5:SEQ-4;6:SEQ-4
//MONOLITHIC
...
[op1](state=1)&(op1=4) -> p14:(state'=2)&(op1'=1) + (1-p14):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op2](state=2)&(op2=4) -> p24:(state'=7)&(op2'=1) + (1-p24):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op3](state=3)&(op3=4) -> p34:(state'=6)&(op3'=1) + (1-p34):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op4](state=4)&(op4=4) -> p44:(state'=8)&(op4'=1) + (1-p44):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op5](state=5)&(op5=4) -> p54:(state'=6)&(op5'=1) + (1-p54):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op6](state=6)&(op6=4) -> p64:(state'=10)&(op6'=1) + (1-p64):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
endmodule
