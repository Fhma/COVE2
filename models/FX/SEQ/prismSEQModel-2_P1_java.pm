...
//prob, cost, time
//MODEL_PATTERNS
//1:SEQ-2;2:SEQ-2;3:SEQ-2;4:SEQ-2;5:SEQ-2;6:SEQ-2
//MONOLITHIC
...
[op1](state=1)&(op1=2) -> p12:(state'=2)&(op1'=1) + (1-p12):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
[op2](state=2)&(op2=1) -> p21:(state'=7)&(op2'=1) + (1-p21):(op2'=2);
[op2](state=2)&(op2=2) -> p22:(state'=7)&(op2'=1) + (1-p22):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
[op3](state=3)&(op3=1) -> p31:(state'=6)&(op3'=1) + (1-p31):(op3'=2);
[op3](state=3)&(op3=2) -> p32:(state'=6)&(op3'=1) + (1-p32):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
[op4](state=4)&(op4=1) -> p41:(state'=8)&(op4'=1) + (1-p41):(op4'=2);
[op4](state=4)&(op4=2) -> p42:(state'=8)&(op4'=1) + (1-p42):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
[op5](state=5)&(op5=1) -> p51:(state'=6)&(op5'=1) + (1-p51):(op5'=2);
[op5](state=5)&(op5=2) -> p52:(state'=6)&(op5'=1) + (1-p52):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
[op6](state=6)&(op6=1) -> p61:(state'=10)&(op6'=1) + (1-p61):(op6'=2);
[op6](state=6)&(op6=2) -> p62:(state'=10)&(op6'=1) + (1-p62):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
endmodule
