...
//prob, cost, time
//MODEL_PATTERNS
//1:PROB-3;2:PROB-3;3:PROB-3;4:PROB-3;5:PROB-3;6:PROB-3
//MONOLITHIC
...
[choice1] (state=1)&(op1=0) -> z11:(op1'=1)+z12:(op1'=2)+z13:(op1'=3);
...
[choice2] (state=2)&(op2=0) -> z21:(op2'=1)+z22:(op2'=2)+z23:(op2'=3);
...
[choice3] (state=3)&(op3=0) -> z31:(op3'=1)+z32:(op3'=2)+z33:(op3'=3);
...
[choice4] (state=4)&(op4=0) -> z41:(op4'=1)+z42:(op4'=2)+z43:(op4'=3);
...
[choice5] (state=5)&(op5=0) -> z51:(op5'=1)+z52:(op5'=2)+z53:(op5'=3);
...
[choice6] (state=6)&(op6=0) -> z61:(op6'=1)+z62:(op6'=2)+z63:(op6'=3);
