...
//prob, cost, time
//MODEL_PATTERNS
//1:PROB-5;2:PROB-5;3:PROB-5;4:PROB-5;5:PROB-5;6:PROB-5
//MONOLITHIC
...
[choice1] (state=1)&(op1=0) -> z11:(op1'=1)+z12:(op1'=2)+z13:(op1'=3)+z14:(op1'=4)+z15:(op1'=5);
...
[op15](state=1)&(op1=5) -> p15:(state'=2)&(op1'=0) + (1-p15):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
[choice2] (state=2)&(op2=0) -> z21:(op2'=1)+z22:(op2'=2)+z23:(op2'=3)+z24:(op2'=4)+z25:(op2'=5);
...
[op25](state=2)&(op2=5) -> p25:(state'=7)&(op2'=0) + (1-p25):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
[choice3] (state=3)&(op3=0) -> z31:(op3'=1)+z32:(op3'=2)+z33:(op3'=3)+z34:(op3'=4)+z35:(op3'=5);
...
[op35](state=3)&(op3=5) -> p35:(state'=6)&(op3'=0) + (1-p35):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
[choice4] (state=4)&(op4=0) -> z41:(op4'=1)+z42:(op4'=2)+z43:(op4'=3)+z44:(op4'=4)+z45:(op4'=5);
...
[op45](state=4)&(op4=5) -> p45:(state'=8)&(op4'=0) + (1-p45):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
[choice5] (state=5)&(op5=0) -> z51:(op5'=1)+z52:(op5'=2)+z53:(op5'=3)+z54:(op5'=4)+z55:(op5'=5);
...
[op55](state=5)&(op5=5) -> p55:(state'=6)&(op5'=0) + (1-p55):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
[choice6] (state=6)&(op6=0) -> z61:(op6'=1)+z62:(op6'=2)+z63:(op6'=3)+z64:(op6'=4)+z65:(op6'=5);
...
[op65](state=6)&(op6=5) -> p65:(state'=10)&(op6'=0) + (1-p65):(state'=9)&(op1'=0)&(op2'=0)&(op3'=0)&(op4'=0)&(op5'=0)&(op6'=0);
endmodule
