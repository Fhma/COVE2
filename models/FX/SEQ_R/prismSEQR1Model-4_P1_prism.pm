...
//prob, cost, time
//MODEL_PATTERNS
//1:SEQR1-4;2:SEQR1-4;3:SEQR1-4;4:SEQR1-4;5:SEQR1-4;6:SEQR1-4
//MONOLITHIC
...
[op14r] (state=1)&(op1=4)&(retry=2) -> r14:(state'=1)&(op1'=4)&(retry'=1) + (1-r14):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op24r] (state=2)&(op2=4)&(retry=2) -> r24:(state'=2)&(op2'=4)&(retry'=1) + (1-r24):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op34r] (state=3)&(op3=4)&(retry=2) -> r34:(state'=3)&(op3'=4)&(retry'=1) + (1-r34):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op44r] (state=4)&(op4=4)&(retry=2) -> r44:(state'=4)&(op4'=4)&(retry'=1) + (1-r44):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op54r] (state=5)&(op5=4)&(retry=2) -> r54:(state'=5)&(op5'=4)&(retry'=1) + (1-r54):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
...
[op64r] (state=6)&(op6=4)&(retry=2) -> r64:(state'=6)&(op6'=4)&(retry'=1) + (1-r64):(state'=9)&(op1'=1)&(op2'=1)&(op3'=1)&(op4'=1)&(op5'=1)&(op6'=1);
endmodule
